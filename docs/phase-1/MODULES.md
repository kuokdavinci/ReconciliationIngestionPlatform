...
| `src/application/ingestion/` | Source-unit sequencing, claim, retry, checkpoint, recovery view | `source_unit_orchestrator.py`, `recovery_view.py` |
...
| `src/pipeline/` | File/row processing và batch write | `ingestion_pipeline.py`, `row_pipeline.py`, `batch_writer.py` |
