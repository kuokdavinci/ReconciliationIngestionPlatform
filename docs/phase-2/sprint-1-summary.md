...
|---|---|---|
| **Database Schema** | [`alembic/versions/0002_ingestion_idempotency.py`](../../alembic/versions/0002_ingestion_idempotency.py)<br>[`src/models/postgres.py`](../../src/models/postgres.py) | Thêm cột `ingestion_key` NOT NULL và tạo Unique Constraint `(identify, ingestion_key)` trên PostgreSQL. |
| **Data Models & Repos** | [`src/models/data_container.py`](../../src/models/data_container.py)<br>[`src/models/internal_transaction.py`](../../src/models/internal_transaction.py)<br>[`src/models/reconciliation_result.py`](../../src/models/reconciliation_result.py) | Chuyển toàn bộ truy vấn CRUD dữ liệu giao dịch sang PostgreSQL SQLAlchemy Async Engine. |
