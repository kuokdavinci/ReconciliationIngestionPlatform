...
import type { ReviewPacket, ScopeClassificationInfo } from "@/types/review-center";
      ...
      {!scopeLoading && !scopeError && scopeClassification && (
        <>
          ...
          {partnerPreview.length > 0 && (
            <details className={styles.sectionCard} style={{ marginTop: 16 }}>
              <summary className={styles.sectionCardHeading}>
                <div>
